...
export const mockProjects: Project[] = [
  {
    ...
    status: "Activo",
    tasks: [
      { id: "t1", name: "Estudio de factibilidad", description: "Análisis técnico y financiero", projectId: "p1", createdBy: "u2" },
      { id: "t2", name: "Diseño de ingeniería", description: "Planos y especificaciones técnicas", projectId: "p1", createdBy: "u2" },
      { id: "t3", name: "Adquisición de materiales", description: "Compra de paneles y equipos", projectId: "p1", createdBy: "u4" },
      { id: "t4", name: "Instalación eléctrica", description: "Montaje de sistemas eléctricos", projectId: "p1", createdBy: "u4" },
    ],
  ...
  },
  {
    ...
    status: "Activo",
    tasks: [
      { id: "t5", name: "Diseño arquitectónico", description: "Planos y renders del edificio", projectId: "p2", createdBy: "u3" },
      { id: "t6", name: "Cálculo estructural", description: "Análisis sísmico y estructural", projectId: "p2", createdBy: "u2" },
      { id: "t7", name: "Supervisión de obra", description: "Control diario de avance", projectId: "p2", createdBy: "u2" },
      { id: "t8", name: "Gestión de permisos", description: "Trámites municipales y DOM", projectId: "p2", createdBy: "u3" },
    ],
  ...
  },
  {
    ...
    status: "Activo",
    tasks: [
      { id: "t9", name: "Levantamiento de requisitos", description: "Reuniones con stakeholders", projectId: "p3", createdBy: "u3" },
      { id: "t10", name: "Diseño UI/UX", description: "Wireframes y prototipos", projectId: "p3", createdBy: "u5" },
      { id: "t11", name: "Desarrollo Frontend", description: "Implementación de la interfaz", projectId: "p3", createdBy: "u6" },
      { id: "t12", name: "Desarrollo Backend", description: "API y base de datos", projectId: "p3", createdBy: "u6" },
    ],
  ...
  },
  {
    ...
    status: "Pausado",
    tasks: [
      { id: "t13", name: "Auditoría de infraestructura", description: "Inventario de servidores actuales", projectId: "p4", createdBy: "u4" },
      { id: "t14", name: "Plan de migración", description: "Estrategia y cronograma", projectId: "p4", createdBy: "u6" },
      { id: "t15", name: "Migración de datos", description: "Transferencia de bases de datos", projectId: "p4", createdBy: "u4" },
    ],
