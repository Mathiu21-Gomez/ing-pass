      ...
      <div className="relative px-5 py-5 shrink-0">
        ...
        <div className="relative">
          ...
          <div className="mt-1.5 flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-medium text-sidebar-foreground/40">Coordinador</span>
          </div>
        </div>
      </div>
        ...
        <div className="rounded-xl border border-sidebar-border/50 bg-sidebar-accent/40 p-3 hover:bg-sidebar-accent/70 transition-colors duration-200">
          <div className="flex items-center gap-3">
            <div className="relative shrink-0">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 text-[11px] font-bold text-white shadow-sm ring-2 ring-amber-500/20">
                {initials}
              </div>
