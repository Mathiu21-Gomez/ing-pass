            ...
            <div className="border-t border-sidebar-border p-3">
                ...
                <div className="rounded-xl bg-sidebar-accent/60 p-3">
                    <div className="flex items-center gap-3">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-teal-500 to-teal-600 text-xs font-bold text-white shadow-sm">
...
export function ExternoSidebar() {
